...
3. Note the **Username** and **Password** (or set your own)
4. Keep **Port**: `6500`
5. Click **Save**

**Important:** Write down the username and password - you'll need them for Radarr and Sonarr.

**Optional - qBittorrent / *Arr Settings:**
1. Go to **Settings** → **qBittorrent / *Arr** tab
2. Keep **Post Torrent Download Action**: `Download all files to host`
3. Keep **Post Download Action**: `Remove Torrent From Client And Provider`
4. Enable **Only download available files on debrid provider** (recommended)
5. Set **Minimum file size to download**: `10` MB (avoids downloading samples/extras)
...
|---------|-----|--------------|
| RDTClient | http://localhost:6500 | 6500 |
...
When connecting services inside Docker, use these hostnames:
...
- **1080p** - Best balance of quality and file size for most content
- **4K/2160p** - Only if you have a 4K display and fast internet
- **720p** - Good for limited storage or slower connections

### Storage Considerations

- Movies: Average 5-10 GB each at 1080p
- TV Episodes: Average 1-3 GB each at 1080p
- Plan for at least 500 GB for a modest library

### Network Performance

- RDTClient downloads from Real-Debrid's servers (fast CDN)
- Jellyfin streaming requires good local network bandwidth
- Enable hardware transcoding if your device supports it
...
- [ ] RDTClient
  ...
  - [ ] qBittorrent emulation credentials noted

- [ ] Prowlarr
  - [ ] Initial setup complete
  - [ ] Flaresolverr added as indexer proxy
  - [ ] At least 3 indexers added
  - [ ] Connected to Radarr
  - [ ] Connected to Sonarr

- [ ] Radarr
  - [ ] Root folder set to /media/movies
  - [ ] RDTClient added as download client
  - [ ] Indexers synced from Prowlarr
  - [ ] API key copied to Prowlarr
...
- [ ] Jellyfin
  - [ ] Admin user created
  - [ ] Movies library added
  - [ ] TV Shows library added
  - [ ] Hardware acceleration configured (optional)
